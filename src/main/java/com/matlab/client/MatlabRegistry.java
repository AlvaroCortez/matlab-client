package com.matlab.client;

import com.matlab.client.model.DiscoveryHost;
import com.matlab.client.model.DiscoveryHosts;
...
@Service
public class MatlabRegistry implements ApplicationListener<ApplicationReadyEvent> {

    private static final Logger LOGGER = LoggerFactory.getLogger(MatlabRegistry.class);
